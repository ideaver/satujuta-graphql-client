...
abstract class GUserUpdateOneData_userUpdateOne_hotelsCreated
    implements
        Built<GUserUpdateOneData_userUpdateOne_hotelsCreated, GUserUpdateOneData_userUpdateOne_hotelsCreatedBuilder> {
  GUserUpdateOneData_userUpdateOne_hotelsCreated._();

  factory GUserUpdateOneData_userUpdateOne_hotelsCreated(
          [Function(GUserUpdateOneData_userUpdateOne_hotelsCreatedBuilder b) updates]) =
      _$GUserUpdateOneData_userUpdateOne_hotelsCreated;

  static void _initializeBuilder(GUserUpdateOneData_userUpdateOne_hotelsCreatedBuilder b) => b..G__typename = 'Hotel';
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  int get id;
  String get name;
  _i2.GDateTime get createdAt;
  static Serializer<GUserUpdateOneData_userUpdateOne_hotelsCreated> get serializer =>
      _$gUserUpdateOneDataUserUpdateOneHotelsCreatedSerializer;
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GUserUpdateOneData_userUpdateOne_hotelsCreated.serializer,
        this,
      ) as Map<String, dynamic>);
  static GUserUpdateOneData_userUpdateOne_hotelsCreated? fromJson(Map<String, dynamic> json) =>
