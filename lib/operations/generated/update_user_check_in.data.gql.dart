...
part 'update_user_check_in.data.gql.g.dart';
...
abstract class GUserUpdateOneData_userUpdateOne_checkIns
    implements
        Built<GUserUpdateOneData_userUpdateOne_checkIns,
  ...
  factory GUserUpdateOneData_userUpdateOne_checkIns(
      [Function(GUserUpdateOneData_userUpdateOne_checkInsBuilder b)
          updates]) = _$GUserUpdateOneData_userUpdateOne_checkIns;

  static void _initializeBuilder(
          GUserUpdateOneData_userUpdateOne_checkInsBuilder b) =>
  ...
  static GUserUpdateOneData_userUpdateOne_checkIns? fromJson(
          Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(
        GUserUpdateOneData_userUpdateOne_checkIns.serializer,
        json,
