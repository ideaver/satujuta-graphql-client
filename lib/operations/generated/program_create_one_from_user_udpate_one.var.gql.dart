...
abstract class GMutationVars implements Built<GMutationVars, GMutationVarsBuilder> {
  GMutationVars._();

  factory GMutationVars([Function(GMutationVarsBuilder b) updates]) = _$GMutationVars;
  ...
  static GMutationVars? fromJson(Map<String, dynamic> json) => _i2.serializers.deserializeWith(
        GMutationVars.serializer,
        json,
      );
}
