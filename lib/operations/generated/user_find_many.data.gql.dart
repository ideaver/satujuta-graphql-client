...
abstract class GUserFindManyData
    implements Built<GUserFindManyData, GUserFindManyDataBuilder> {
  GUserFindManyData._();

  factory GUserFindManyData([Function(GUserFindManyDataBuilder b) updates]) =
      _$GUserFindManyData;

  static void _initializeBuilder(GUserFindManyDataBuilder b) =>
      b..G__typename = 'Query';
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  BuiltList<GUserFindManyData_userFindMany>? get userFindMany;
  static Serializer<GUserFindManyData> get serializer =>
      _$gUserFindManyDataSerializer;
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GUserFindManyData.serializer,
        this,
      ) as Map<String, dynamic>);
  static GUserFindManyData? fromJson(Map<String, dynamic> json) =>
...
abstract class GUserFindManyData_userFindMany
    implements
        Built<GUserFindManyData_userFindMany,
            GUserFindManyData_userFindManyBuilder> {
  GUserFindManyData_userFindMany._();

  factory GUserFindManyData_userFindMany(
          [Function(GUserFindManyData_userFindManyBuilder b) updates]) =
      _$GUserFindManyData_userFindMany;

  static void _initializeBuilder(GUserFindManyData_userFindManyBuilder b) =>
      b..G__typename = 'User';
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  String get id;
  ...
  static Serializer<GUserFindManyData_userFindMany> get serializer =>
      _$gUserFindManyDataUserFindManySerializer;
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GUserFindManyData_userFindMany.serializer,
        this,
      ) as Map<String, dynamic>);
  static GUserFindManyData_userFindMany? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(
        GUserFindManyData_userFindMany.serializer,
        json,
      );
