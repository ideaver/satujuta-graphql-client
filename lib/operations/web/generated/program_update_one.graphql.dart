...
class Mutation$ProgramUpdateOne$programUpdateOne {
  ...
  factory Mutation$ProgramUpdateOne$programUpdateOne.fromJson(
    ...
    return Mutation$ProgramUpdateOne$programUpdateOne(
      ...
      createdBy: Mutation$ProgramUpdateOne$programUpdateOne$createdBy.fromJson(
  ...
  final Mutation$ProgramUpdateOne$programUpdateOne$createdBy createdBy;
...
abstract class CopyWith$Mutation$ProgramUpdateOne$programUpdateOne<TRes> {
  ...
  TRes call({
    ...
    String? startDate,
    String? dueDate,
    Mutation$ProgramUpdateOne$programUpdateOne$createdBy? createdBy,
  ...
  CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$category<TRes>
      get category;
  CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy<TRes>
      get createdBy;
  TRes Images(
...
class _CopyWithImpl$Mutation$ProgramUpdateOne$programUpdateOne<TRes>
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$ProgramUpdateOne$programUpdateOne(
        ...
        createdBy: createdBy == _undefined || createdBy == null
            ? _instance.createdBy
            : (createdBy
                as Mutation$ProgramUpdateOne$programUpdateOne$createdBy),
  ...
  CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy<TRes>
    ...
    return CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy(
...
class _CopyWithStubImpl$Mutation$ProgramUpdateOne$programUpdateOne<TRes>
  ...
  CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy<TRes>
      get createdBy =>
          CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy.stub(
              _res);
  Images(_fn) => _res;
}
...
class Mutation$ProgramUpdateOne$programUpdateOne$createdBy {
  Mutation$ProgramUpdateOne$programUpdateOne$createdBy({
    required this.id,
    this.$__typename = 'User',
  });

  factory Mutation$ProgramUpdateOne$programUpdateOne$createdBy.fromJson(
      Map<String, dynamic> json) {
    final l$id = json['id'];
    final l$$__typename = json['__typename'];
    return Mutation$ProgramUpdateOne$programUpdateOne$createdBy(
      id: (l$id as String),
      $__typename: (l$$__typename as String),
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Mutation$ProgramUpdateOne$programUpdateOne$createdBy) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Mutation$ProgramUpdateOne$programUpdateOne$createdBy
    on Mutation$ProgramUpdateOne$programUpdateOne$createdBy {
  CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy<
          Mutation$ProgramUpdateOne$programUpdateOne$createdBy>
      get copyWith =>
          CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy(
            this,
...
abstract class CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy<
    TRes> {
  factory CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy(
    Mutation$ProgramUpdateOne$programUpdateOne$createdBy instance,
    TRes Function(Mutation$ProgramUpdateOne$programUpdateOne$createdBy) then,
  ) = _CopyWithImpl$Mutation$ProgramUpdateOne$programUpdateOne$createdBy;

  factory CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy.stub(
          TRes res) =
      _CopyWithStubImpl$Mutation$ProgramUpdateOne$programUpdateOne$createdBy;
...
class _CopyWithImpl$Mutation$ProgramUpdateOne$programUpdateOne$createdBy<TRes>
    implements
        CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy<TRes> {
  _CopyWithImpl$Mutation$ProgramUpdateOne$programUpdateOne$createdBy(
    this._instance,
  ...
  final Mutation$ProgramUpdateOne$programUpdateOne$createdBy _instance;

  final TRes Function(Mutation$ProgramUpdateOne$programUpdateOne$createdBy)
      _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$ProgramUpdateOne$programUpdateOne$createdBy(
...
class _CopyWithStubImpl$Mutation$ProgramUpdateOne$programUpdateOne$createdBy<
        TRes>
    implements
        CopyWith$Mutation$ProgramUpdateOne$programUpdateOne$createdBy<TRes> {
  _CopyWithStubImpl$Mutation$ProgramUpdateOne$programUpdateOne$createdBy(
