...
class Variables$Query$TransactionFindManyByAccountId {
  ...
  factory Variables$Query$TransactionFindManyByAccountId.fromJson(Map<String, dynamic> data) {
    ...
    if (data.containsKey('where')) {
      ...
      result$data['where'] = l$where == null ? null : Input$TransactionWhereInput.fromJson((l$where as Map<String, dynamic>));
    }
    if (data.containsKey('orderBy')) {
      final l$orderBy = data['orderBy'];
      result$data['orderBy'] =
          (l$orderBy as List<dynamic>?)?.map((e) => Input$TransactionOrderByWithRelationInput.fromJson((e as Map<String, dynamic>))).toList();
    }
  ...
  Input$TransactionWhereInput? get where => (_$data['where'] as Input$TransactionWhereInput?);
  List<Input$TransactionOrderByWithRelationInput>? get orderBy => (_$data['orderBy'] as List<Input$TransactionOrderByWithRelationInput>?);
  ...
  CopyWith$Variables$Query$TransactionFindManyByAccountId<Variables$Query$TransactionFindManyByAccountId> get copyWith =>
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Variables$Query$TransactionFindManyByAccountId) || runtimeType != other.runtimeType) {
      return false;
    }
    final l$skip = skip;
...
abstract class CopyWith$Variables$Query$TransactionFindManyByAccountId<TRes> {
  ...
  factory CopyWith$Variables$Query$TransactionFindManyByAccountId.stub(TRes res) = _CopyWithStubImpl$Variables$Query$TransactionFindManyByAccountId;
...
class _CopyWithImpl$Variables$Query$TransactionFindManyByAccountId<TRes> implements CopyWith$Variables$Query$TransactionFindManyByAccountId<TRes> {
  _CopyWithImpl$Variables$Query$TransactionFindManyByAccountId(
    this._instance,
    this._then,
  );
  ...
  TRes call({
    ...
    Object? orderBy = _undefined,
      ...
      _then(Variables$Query$TransactionFindManyByAccountId._({
        ...
        if (where != _undefined) 'where': (where as Input$TransactionWhereInput?),
        if (orderBy != _undefined) 'orderBy': (orderBy as List<Input$TransactionOrderByWithRelationInput>?),
      }));
}
...
class Query$TransactionFindManyByAccountId {
  ...
  factory Query$TransactionFindManyByAccountId.fromJson(Map<String, dynamic> json) {
    ...
    return Query$TransactionFindManyByAccountId(
      transactionFindMany: (l$transactionFindMany as List<dynamic>?)
          ?.map((e) => Query$TransactionFindManyByAccountId$transactionFindMany.fromJson((e as Map<String, dynamic>)))
          .toList(),
      $__typename: (l$$__typename as String),
    );
  }

  final List<Query$TransactionFindManyByAccountId$transactionFindMany>? transactionFindMany;
  ...
  Map<String, dynamic> toJson() {
    ...
    _resultData['transactionFindMany'] = l$transactionFindMany?.map((e) => e.toJson()).toList();
  ...
  int get hashCode {
    ...
    final l$$__typename = $__typename;
    return Object.hashAll([
      l$transactionFindMany == null ? null : Object.hashAll(l$transactionFindMany.map((v) => v)),
      l$$__typename,
    ]);
  }
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Query$TransactionFindManyByAccountId) || runtimeType != other.runtimeType) {
      return false;
    }
    final l$transactionFindMany = transactionFindMany;
...
extension UtilityExtension$Query$TransactionFindManyByAccountId on Query$TransactionFindManyByAccountId {
  CopyWith$Query$TransactionFindManyByAccountId<Query$TransactionFindManyByAccountId> get copyWith => CopyWith$Query$TransactionFindManyByAccountId(
        this,
        (i) => i,
      );
}
...
abstract class CopyWith$Query$TransactionFindManyByAccountId<TRes> {
  ...
  factory CopyWith$Query$TransactionFindManyByAccountId.stub(TRes res) = _CopyWithStubImpl$Query$TransactionFindManyByAccountId;

  TRes call({
    List<Query$TransactionFindManyByAccountId$transactionFindMany>? transactionFindMany,
    String? $__typename,
  });
  TRes transactionFindMany(
      Iterable<Query$TransactionFindManyByAccountId$transactionFindMany>? Function(
              Iterable<CopyWith$Query$TransactionFindManyByAccountId$transactionFindMany<Query$TransactionFindManyByAccountId$transactionFindMany>>?)
          _fn);
}

class _CopyWithImpl$Query$TransactionFindManyByAccountId<TRes> implements CopyWith$Query$TransactionFindManyByAccountId<TRes> {
  _CopyWithImpl$Query$TransactionFindManyByAccountId(
    this._instance,
    this._then,
  );
    ...
    Object? $__typename = _undefined,
      ...
      _then(Query$TransactionFindManyByAccountId(
        transactionFindMany: transactionFindMany == _undefined
            ...
            : (transactionFindMany as List<Query$TransactionFindManyByAccountId$transactionFindMany>?),
        $__typename: $__typename == _undefined || $__typename == null ? _instance.$__typename : ($__typename as String),
      ));
  TRes transactionFindMany(
          Iterable<Query$TransactionFindManyByAccountId$transactionFindMany>? Function(
                  Iterable<
                      CopyWith$Query$TransactionFindManyByAccountId$transactionFindMany<Query$TransactionFindManyByAccountId$transactionFindMany>>?)
              _fn) =>
      call(
          transactionFindMany: _fn(_instance.transactionFindMany?.map((e) => CopyWith$Query$TransactionFindManyByAccountId$transactionFindMany(
                e,
                (i) => i,
              )))?.toList());
}

class _CopyWithStubImpl$Query$TransactionFindManyByAccountId<TRes> implements CopyWith$Query$TransactionFindManyByAccountId<TRes> {
...
const documentNodeQueryTransactionFindManyByAccountId = DocumentNode(definitions: [
...
Query$TransactionFindManyByAccountId _parserFn$Query$TransactionFindManyByAccountId(Map<String, dynamic> data) =>
    Query$TransactionFindManyByAccountId.fromJson(data);
typedef OnQueryComplete$Query$TransactionFindManyByAccountId = FutureOr<void> Function(
  Map<String, dynamic>?,
  Query$TransactionFindManyByAccountId?,
);

class Options$Query$TransactionFindManyByAccountId extends graphql.QueryOptions<Query$TransactionFindManyByAccountId> {
    ...
    graphql.OnQueryError? onError,
        ...
        super(
          ...
          onComplete: onComplete == null
              ...
              : (data) => onComplete(
                    data,
                    data == null ? null : _parserFn$Query$TransactionFindManyByAccountId(data),
                  ),
          onError: onError,
  ...
  final OnQueryComplete$Query$TransactionFindManyByAccountId? onCompleteWithParsed;
...
class WatchOptions$Query$TransactionFindManyByAccountId extends graphql.WatchQueryOptions<Query$TransactionFindManyByAccountId> {
...
class FetchMoreOptions$Query$TransactionFindManyByAccountId extends graphql.FetchMoreOptions {
...
extension ClientExtension$Query$TransactionFindManyByAccountId on graphql.GraphQLClient {
  Future<graphql.QueryResult<Query$TransactionFindManyByAccountId>> query$TransactionFindManyByAccountId(
          [Options$Query$TransactionFindManyByAccountId? options]) async =>
      await this.query(options ?? Options$Query$TransactionFindManyByAccountId());
  graphql.ObservableQuery<Query$TransactionFindManyByAccountId> watchQuery$TransactionFindManyByAccountId(
          [WatchOptions$Query$TransactionFindManyByAccountId? options]) =>
      this.watchQuery(options ?? WatchOptions$Query$TransactionFindManyByAccountId());
  void writeQuery$TransactionFindManyByAccountId({
    ...
    bool broadcast = true,
      ...
      this.writeQuery(
        graphql.Request(
          operation: graphql.Operation(document: documentNodeQueryTransactionFindManyByAccountId),
          variables: variables?.toJson() ?? const {},
        ),
        data: data.toJson(),
        broadcast: broadcast,
      );
  Query$TransactionFindManyByAccountId? readQuery$TransactionFindManyByAccountId({
    Variables$Query$TransactionFindManyByAccountId? variables,
    ...
    return result == null ? null : Query$TransactionFindManyByAccountId.fromJson(result);
  }
}

graphql_flutter.QueryHookResult<Query$TransactionFindManyByAccountId> useQuery$TransactionFindManyByAccountId(
        [Options$Query$TransactionFindManyByAccountId? options]) =>
    graphql_flutter.useQuery(options ?? Options$Query$TransactionFindManyByAccountId());
graphql.ObservableQuery<Query$TransactionFindManyByAccountId> useWatchQuery$TransactionFindManyByAccountId(
        [WatchOptions$Query$TransactionFindManyByAccountId? options]) =>
    graphql_flutter.useWatchQuery(options ?? WatchOptions$Query$TransactionFindManyByAccountId());

class Query$TransactionFindManyByAccountId$Widget extends graphql_flutter.Query<Query$TransactionFindManyByAccountId> {
  Query$TransactionFindManyByAccountId$Widget({
    widgets.Key? key,
    Options$Query$TransactionFindManyByAccountId? options,
    required graphql_flutter.QueryBuilder<Query$TransactionFindManyByAccountId> builder,
  }) : super(
          key: key,
...
class Query$TransactionFindManyByAccountId$transactionFindMany {
  ...
  factory Query$TransactionFindManyByAccountId$transactionFindMany.fromJson(Map<String, dynamic> json) {
    final l$id = json['id'];
    ...
    final l$invoiceId = json['invoiceId'];
    ...
    return Query$TransactionFindManyByAccountId$transactionFindMany(
      ...
      transactionCategory: fromJson$Enum$TransactionCategory((l$transactionCategory as String)),
      createdAt: (l$createdAt as String),
      fromAccountId: (l$fromAccountId as int),
      toAccountId: (l$toAccountId as int),
      invoiceId: (l$invoiceId as int?),
  ...
  Map<String, dynamic> toJson() {
    ...
    _resultData['transactionCategory'] = toJson$Enum$TransactionCategory(l$transactionCategory);
    ...
    final l$invoiceId = invoiceId;
    _resultData['invoiceId'] = l$invoiceId;
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Query$TransactionFindManyByAccountId$transactionFindMany) || runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
    ...
    final l$invoiceId = invoiceId;
    final lOther$invoiceId = other.invoiceId;
    if (l$invoiceId != lOther$invoiceId) {
      return false;
    }
    final l$uniqueCode = uniqueCode;
...
extension UtilityExtension$Query$TransactionFindManyByAccountId$transactionFindMany on Query$TransactionFindManyByAccountId$transactionFindMany {
  CopyWith$Query$TransactionFindManyByAccountId$transactionFindMany<Query$TransactionFindManyByAccountId$transactionFindMany> get copyWith =>
...
abstract class CopyWith$Query$TransactionFindManyByAccountId$transactionFindMany<TRes> {
  factory CopyWith$Query$TransactionFindManyByAccountId$transactionFindMany(
    ...
    TRes Function(Query$TransactionFindManyByAccountId$transactionFindMany) then,
  ) = _CopyWithImpl$Query$TransactionFindManyByAccountId$transactionFindMany;

  factory CopyWith$Query$TransactionFindManyByAccountId$transactionFindMany.stub(TRes res) =
...
class _CopyWithImpl$Query$TransactionFindManyByAccountId$transactionFindMany<TRes>
    implements CopyWith$Query$TransactionFindManyByAccountId$transactionFindMany<TRes> {
  _CopyWithImpl$Query$TransactionFindManyByAccountId$transactionFindMany(
    this._instance,
    this._then,
  );
  ...
  final TRes Function(Query$TransactionFindManyByAccountId$transactionFindMany) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Query$TransactionFindManyByAccountId$transactionFindMany(
        ...
        amount: amount == _undefined || amount == null ? _instance.amount : (amount as double),
        status: status == _undefined || status == null ? _instance.status : (status as Enum$TransactionStatus),
        transactionCategory: transactionCategory == _undefined || transactionCategory == null
        ...
        fromAccountId: fromAccountId == _undefined || fromAccountId == null ? _instance.fromAccountId : (fromAccountId as int),
        toAccountId: toAccountId == _undefined || toAccountId == null ? _instance.toAccountId : (toAccountId as int),
        invoiceId: invoiceId == _undefined ? _instance.invoiceId : (invoiceId as int?),
        uniqueCode: uniqueCode == _undefined ? _instance.uniqueCode : (uniqueCode as int?),
        proofUrl: proofUrl == _undefined ? _instance.proofUrl : (proofUrl as String?),
        $__typename: $__typename == _undefined || $__typename == null ? _instance.$__typename : ($__typename as String),
      ));
}

class _CopyWithStubImpl$Query$TransactionFindManyByAccountId$transactionFindMany<TRes>
    implements CopyWith$Query$TransactionFindManyByAccountId$transactionFindMany<TRes> {
  _CopyWithStubImpl$Query$TransactionFindManyByAccountId$transactionFindMany(this._res);
