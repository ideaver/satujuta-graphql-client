...
class Variables$Query$CountTotalUserWithProjectsInvestor {
  factory Variables$Query$CountTotalUserWithProjectsInvestor(
          {Input$UserWhereInput? where}) =>
      Variables$Query$CountTotalUserWithProjectsInvestor._({
        if (where != null) r'where': where,
      });

  Variables$Query$CountTotalUserWithProjectsInvestor._(this._$data);

  factory Variables$Query$CountTotalUserWithProjectsInvestor.fromJson(
  ...
  CopyWith$Variables$Query$CountTotalUserWithProjectsInvestor<
          Variables$Query$CountTotalUserWithProjectsInvestor>
      get copyWith =>
          CopyWith$Variables$Query$CountTotalUserWithProjectsInvestor(
            this,
            (i) => i,
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Variables$Query$CountTotalUserWithProjectsInvestor) ||
...
abstract class CopyWith$Variables$Query$CountTotalUserWithProjectsInvestor<
    TRes> {
  ...
  factory CopyWith$Variables$Query$CountTotalUserWithProjectsInvestor.stub(
          TRes res) =
...
class _CopyWithImpl$Variables$Query$CountTotalUserWithProjectsInvestor<TRes>
    implements
        CopyWith$Variables$Query$CountTotalUserWithProjectsInvestor<TRes> {
  _CopyWithImpl$Variables$Query$CountTotalUserWithProjectsInvestor(
    this._instance,
    this._then,
  );
  ...
  TRes call({Object? where = _undefined}) =>
      _then(Variables$Query$CountTotalUserWithProjectsInvestor._({
        ..._instance._$data,
...
class Query$CountTotalUserWithProjectsInvestor {
  ...
  factory Query$CountTotalUserWithProjectsInvestor.fromJson(
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Query$CountTotalUserWithProjectsInvestor) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$userCount = userCount;
...
extension UtilityExtension$Query$CountTotalUserWithProjectsInvestor
    on Query$CountTotalUserWithProjectsInvestor {
  CopyWith$Query$CountTotalUserWithProjectsInvestor<
          Query$CountTotalUserWithProjectsInvestor>
      get copyWith => CopyWith$Query$CountTotalUserWithProjectsInvestor(
            this,
            (i) => i,
          );
}
...
abstract class CopyWith$Query$CountTotalUserWithProjectsInvestor<TRes> {
  ...
  factory CopyWith$Query$CountTotalUserWithProjectsInvestor.stub(TRes res) =
      _CopyWithStubImpl$Query$CountTotalUserWithProjectsInvestor;
...
class _CopyWithImpl$Query$CountTotalUserWithProjectsInvestor<TRes>
    implements CopyWith$Query$CountTotalUserWithProjectsInvestor<TRes> {
  _CopyWithImpl$Query$CountTotalUserWithProjectsInvestor(
    this._instance,
    this._then,
  );
...
class _CopyWithStubImpl$Query$CountTotalUserWithProjectsInvestor<TRes>
    implements CopyWith$Query$CountTotalUserWithProjectsInvestor<TRes> {
...
const documentNodeQueryCountTotalUserWithProjectsInvestor =
...
Query$CountTotalUserWithProjectsInvestor
    _parserFn$Query$CountTotalUserWithProjectsInvestor(
            Map<String, dynamic> data) =>
        Query$CountTotalUserWithProjectsInvestor.fromJson(data);
typedef OnQueryComplete$Query$CountTotalUserWithProjectsInvestor
    = FutureOr<void> Function(
  Map<String, dynamic>?,
  Query$CountTotalUserWithProjectsInvestor?,
);

class Options$Query$CountTotalUserWithProjectsInvestor
    extends graphql.QueryOptions<Query$CountTotalUserWithProjectsInvestor> {
  ...
  final OnQueryComplete$Query$CountTotalUserWithProjectsInvestor?
...
class WatchOptions$Query$CountTotalUserWithProjectsInvestor extends graphql
    .WatchQueryOptions<Query$CountTotalUserWithProjectsInvestor> {
...
class FetchMoreOptions$Query$CountTotalUserWithProjectsInvestor
...
extension ClientExtension$Query$CountTotalUserWithProjectsInvestor
    on graphql.GraphQLClient {
  Future<graphql.QueryResult<Query$CountTotalUserWithProjectsInvestor>>
      query$CountTotalUserWithProjectsInvestor(
              [Options$Query$CountTotalUserWithProjectsInvestor?
                  options]) async =>
          await this.query(
              options ?? Options$Query$CountTotalUserWithProjectsInvestor());
  graphql.ObservableQuery<Query$CountTotalUserWithProjectsInvestor>
      watchQuery$CountTotalUserWithProjectsInvestor(
              [WatchOptions$Query$CountTotalUserWithProjectsInvestor?
                  options]) =>
  ...
  Query$CountTotalUserWithProjectsInvestor?
      readQuery$CountTotalUserWithProjectsInvestor({
    Variables$Query$CountTotalUserWithProjectsInvestor? variables,
    ...
    return result == null
        ? null
        : Query$CountTotalUserWithProjectsInvestor.fromJson(result);
  }
}

graphql_flutter.QueryHookResult<Query$CountTotalUserWithProjectsInvestor>
    useQuery$CountTotalUserWithProjectsInvestor(
            [Options$Query$CountTotalUserWithProjectsInvestor? options]) =>
        graphql_flutter.useQuery(
            options ?? Options$Query$CountTotalUserWithProjectsInvestor());
graphql.ObservableQuery<Query$CountTotalUserWithProjectsInvestor>
    useWatchQuery$CountTotalUserWithProjectsInvestor(
            [WatchOptions$Query$CountTotalUserWithProjectsInvestor? options]) =>
        graphql_flutter.useWatchQuery(
            options ?? WatchOptions$Query$CountTotalUserWithProjectsInvestor());

class Query$CountTotalUserWithProjectsInvestor$Widget
    extends graphql_flutter.Query<Query$CountTotalUserWithProjectsInvestor> {
  Query$CountTotalUserWithProjectsInvestor$Widget({
    widgets.Key? key,
    Options$Query$CountTotalUserWithProjectsInvestor? options,
    required graphql_flutter
        .QueryBuilder<Query$CountTotalUserWithProjectsInvestor>
        builder,
  }) : super(
          key: key,
          options:
